              ...
              {result === "win" && (
                <div className="space-y-4">
                  ...
                  <Button
                    ...
                    size="lg"
                  >
                    {isLoading ? "CLAIMING..." : "CLAIM 2 ALGO 🎉"}
                  </Button>
                </div>
              )}
