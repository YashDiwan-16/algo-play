// Application-wide constants for AlgoPlay platform

// Search & Pagination
export const MAX_SEARCH_RESULTS = 50;
export const PAGE_SIZE = 12;

// Game Version ID Generation
...
// Game & Marketplace Settings
export const POPULAR_FORK_THRESHOLD = 5;
export const MIN_SELL_PRICE = 0.1;
export const MIN_PLAY_DURATION = 5000;
export const ALGO_TO_MICROALGO = 1_000_000;
