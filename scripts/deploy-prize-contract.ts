...
async function deployPrizeContract() {
  ...
  console.log("Initializing Prize contract...");
  ...
  // Fund the contract
  console.log("Funding Prize contract...");
  ...
  console.log(`export NEXT_PUBLIC_PRIZE_APP_ID="${appClient.appClient.appId}"`);
}

deployPrizeContract().catch(console.error);
